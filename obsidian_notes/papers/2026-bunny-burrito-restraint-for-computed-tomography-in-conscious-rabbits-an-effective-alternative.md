...
- **저널**: Veterinary radiology & ultrasound (2026)
- **저자**: Hung-Ting Liu, Jonathan Olijnyk, Jessica Ingman, Ellen Sundberg, Laetitia Volait-Rosset, Alexis Gombert
- **PubMed**: https://pubmed.ncbi.nlm.nih.gov/42644764/
- **DOI**: 10.1111/vru.70230

관련 주제: [[topics/conscious-imaging-restraint]]

#토끼 #CT #보정법 #진정없는영상 #특수동물

## 국문 요약
2021년 3월부터 2023년 12월까지 보호자 소유 토끼 93마리를 대상으로 진행된 후향적 다기관 관찰연구에서, 의식이 있는 토끼의 CT 검사 시 번니 부리토(수건으로 감싸는) 보정법과 플렉시글라스 챔버 보정법, 진정법을 비교했다. 번니 부리토 그룹(36마리)은 플렉시글라스 챔버 그룹(47마리)에 비해 조영 전 영상에서 움직임 인공물이 유의하게 적었고(p=0.02), 치아질환 하위군에서 자세 유지가 더 우수했으며(p=0.03), 조영 후 초기 안정성도 더 좋았다(p=0.04, 신뢰구간 넓음). 번니 부리토와 진정법(10마리) 간 영상 품질은 기술통계상 유사했으며, 검사 중이나 이후 합병증은 보고되지 않았다. 저자들은 번니 부리토 보정법이 플렉시글라스 챔버보다 특정 상황에서 우수하며, 진정 관련 위험 없이 CT 검사 접근성을 높이는 유효하고 안전한 대안이라고 결론지었다.

## English summary
This retrospective multicenter study evaluated the bunny burrito restraint technique as an alternative to plexiglass chamber restraint for CT imaging in 93 conscious client-owned rabbits (2021-2023). The bunny burrito group (n=36) showed significantly fewer motion artifacts in pre-contrast acquisitions, better positioning in the dental disease subgroup, and better early post-contrast stability compared to the plexiglass chamber group (n=47). Image quality was descriptively similar between bunny burrito and sedation (n=10), with no complications reported in either physical restraint group. The findings support bunny burrito restraint as a safe, effective, low-equipment alternative that reduces sedation-related risk in rabbit CT imaging.

## 임상 시사점
토끼 CT 검사 시 진정이 어렵거나 위험도가 높은 환자에서는 번니 부리토(수건 감싸기) 보정법을 우선 고려할 수 있으며, 특히 치아질환 평가 시 플렉시글라스 챔버보다 자세 안정성이 우수하다.
